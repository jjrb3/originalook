...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="{{asset('tema_administrador/dist/img/per.jpg')}}" class="img-circle" alt="User Image">s
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12">
      ...
      <div class="row">
      <div class="col-md-12">
      <center> <h4 class="widget-title">Contenido de servicios registrados</h4>
      <p>En caso de que quiera editar o eliminar contenido dirigirse a la pestaña de opciones.</p></center>

      </div>
      </div>
      </div>
    <br>
      <form class="form-horizontal" action="guardarActualizacion" method="post">
      <fieldset>
      ...
      <select id="categoria" name="categoria" class="form-control" required>
        @foreach($categorias as $categoria)
          @if($categoria['id'] == $servicio['id_categorias'])
      ...
      <div class="col-md-4">
      <input id="textinput" name="servicio" value="{{$servicio['nombre']}}" type="text" placeholder="Elija nombre del servicio" class="form-control input-md" required>
      ...
      <div class="col-md-4">
      <input id="" name="valor" type="number" min="0" value="{{$servicio['valor']}}" placeholder="Valor del servicio" class="form-control input-md" required>
      ...
      <label class="col-md-4 control-label" for=""></label>
      <div class="col-md-4">                     
      <textarea class="form-control" id="" name="descripcion" placeholder="Breve descripción del servicio" required>{{$servicio['descripcion']}}</textarea>
      </div>
      </div>
      ...
      <div class="col-md-4">
      <button id="" name="" class="btn btn-success">Actualizar Servicios</button>
      </div>
      </div>
      ...
      <br>
      @if($mensaje == 'Si')
        <center>SE ACTUALIZÓ EL PERFIL CORRECTAMENTE</center>
      @endif
    </div>
    </div>
