        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-body no-padding">
              <!-- THE CALENDAR -->
          <center><h1>COMO UTILIZAR MI PANEL ADMINISTRATIVO ORIGINALOOK</h1></center> 
            </div>
            <!-- /.box-body -->
                            <div class="container">
                            <div class="row">
                            <div class="col-md-12">
                                <p>1. Al ingresar al panel administrativo, podras observar en la parte izquierda una cantidad de menus los cuales son los siguientes:
                                <ul>
                                  <li>Inicio</li>
                                  <li>Mi perfil</li>
                                  <li>Mis servicios</li>
                                  <li>Mis solicitudes</li>
                                  <li>Mis pagos hechos</li>
                                  <li>Mi portafolio</li>
                                  <li>Documentación</li>
                                  <li>Información</li>
                                </ul>
                                En cada uno de ellos tendras vistas diferentes que te permiten visualizar, agregar, editar o eliminar datos de cada uno de estos modulos informativos
                                </p>
